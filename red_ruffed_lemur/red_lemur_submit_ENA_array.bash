...
#SBATCH --job-name=ENA_tarball_submission
...
config=/gpfs01/home/mbzlld/code_and_scripts/config_files/ENA_tarball_array_config.txt # set the name of the config file
