...
# # generate the list of fastq files and paste them after the -nanopore flag below
# # note that the files are just .fastq rather than .fastq.gz now because they had to be decompressed for shasta input
# find $wkdir/basecalls -type f -name '*calls.fastq' # set the full fastq file name and further path

## create a conda environment and install the software you want
#conda create --name canu
#conda install -c conda-forge -c bioconda canu
