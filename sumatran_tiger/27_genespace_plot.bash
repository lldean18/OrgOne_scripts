...
wkdir=~/data/OrgOne/sumatran_tiger/genespace_ours12
wkdir=~/data/OrgOne/sumatran_tiger/genespace_ours13
...
cut -f1-4 ~/data/OrgOne/sumatran_tiger/liger_reference/GCA_018350195.2_chrs_only_uniq_names_nospaces_liftoff_genes.bed > $wkdir/bed/TigerHaplomeScaffolded.bed
cut -f1-4 ~/data/OrgOne/sumatran_tiger/liger_reference/GCA_018350195.2_scaff_only_names_split_contigs_liftoff_genes.bed > $wkdir/bed/TigerHaplome.bed
...
cut -f1-4 ~/data/OrgOne/sumatran_tiger/hifiasm_asm13/ONTasm.bp.p_ctg_100kb_liftoff_genes.bed > $wkdir/bed/Hifiasm.bed
cut -f1-4 ~/data/OrgOne/sumatran_tiger/NextDenovo_asm/03.ctg_graph/nd.asm_liftoff_genes.bed > $wkdir/bed/NextDenovo.bed
...
cp ~/data/OrgOne/sumatran_tiger/liger_reference/GCA_018350195.2_chrs_only_uniq_names_nospaces_proteins.fasta $wkdir/peptide/TigerHaplomeScaffolded.fa
cp ~/data/OrgOne/sumatran_tiger/liger_reference/GCA_018350195.2_scaff_only_names_split_contigs_proteins.fasta $wkdir/peptide/TigerHaplome.fa
...
cp ~/data/OrgOne/sumatran_tiger/hifiasm_asm13/ONTasm.bp.p_ctg_100kb_proteins.fasta $wkdir/peptide/Hifiasm.fa
cp ~/data/OrgOne/sumatran_tiger/NextDenovo_asm/03.ctg_graph/nd.asm_proteins.fasta $wkdir/peptide/NextDenovo.fa
