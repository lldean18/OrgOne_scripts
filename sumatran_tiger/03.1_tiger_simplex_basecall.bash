...
#/gpfs01/home/mbzlld/data/OrgOne/sumatran_tiger/pod5_files/simplex

##### GENERATE THE ARRAY CONFIG FILE #####
# # generate list of file paths for the array config
# cd /gpfs01/home/mbzlld/data/OrgOne/sumatran_tiger/pod5_files/simplex
# # list all directories containing fast5 files & write to config file
# find . -type f -name '*pod5*' | sed -r 's|/[^/]+$||' |sort -u > ~/code_and_scripts/config_files/sum_tiger_simplex_basecalling_array_config_tmp.txt
# # add the start of the filepath to the config file (bc we cd'd to only get tiger, it only prints from there)
# sed -i 's/[.]/\/gpfs01\/home\/mbzlld\/data\/OrgOne\/sumatran_tiger\/pod5_files\/simplex/' ~/code_and_scripts/config_files/sum_tiger_simplex_basecalling_array_config_tmp.txt
# # add array numbers to config file
# awk '{print NR,$0}' ~/code_and_scripts/config_files/sum_tiger_simplex_basecalling_array_config_tmp.txt > ~/code_and_scripts/config_files/sum_tiger_simplex_basecalling_array_config.txt
# rm ~/code_and_scripts/config_files/sum_tiger_simplex_basecalling_array_config_tmp.txt # remove the temp file

# load cuda module
module load cuda-12.2.2

# set the config file
config=/gpfs01/home/mbzlld/code_and_scripts/config_files/sum_tiger_simplex_basecalling_array_config.txt
