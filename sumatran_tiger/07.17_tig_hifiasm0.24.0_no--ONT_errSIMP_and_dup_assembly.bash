...
# Script to run hifiasm without ONT mode on the error corrected simplex
# reads merged with the duplex reads for the MS reviewers
...
#SBATCH --job-name=tig_hifiasm0.24.0
...
attempt=14
reads=$wkdir/basecalls/duplex_and_herro_simplex.fa.gz
