...
mkdir -p $wkdir/raft_hifiasm_asm2
cd $wkdir/raft_hifiasm_asm2


####### STEP 1 ########
# run hifiasm on all duplex & simplex reads (except the P3 long reads) to obtain error corrected reads and coverage estimate
hifiasm \
-o errorcorrect \
-t 96 \
--write-ec \
...
$wkdir/basecalls/sumatran_tiger_duplex_P3/20230309_1159_2G_PAK98873_d39c7c8c/pod5_pass/SUPlatest_calls.fastq.gz \
...
$wkdir/basecalls/sumatran_tiger_P2/20230113_1342_3F_PAM70827_70386f08/pod5/SUPlatest_calls.fastq.gz 2> errorcorrect.log
