...
# coverage
awk '{print $1, $2}' ONTasm.bp.hap1.p_ctg_mapped_raw_reads_Scleractinia_depth.txt | sort -k1,1 > cov.txt
# length (extract taxid)
awk '{split($2,a,"|"); print $1, a[2], $3}' ONTasm.bp.hap1.p_ctg_Scleractinia.fasta_length.tsv | sort -k1,1 > len.txt
# GC (extract taxid)
awk '{split($2,a,"|"); print $1, a[2], $3}' ONTasm.bp.hap1.p_ctg_Scleractinia.fasta_GC.tsv | sort -k1,1 > gc.txt
