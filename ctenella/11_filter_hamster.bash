...
# awk 'NR % 4 == 1 {sub(/^@/, ""); print}' $wkdir/reads_mapping_to_hamster.fastq > $wkdir/hamster_read_ids.txt
...
# seqkit grep --threads 24 -v -f $wkdir/hamster_read_ids.txt $wkdir/SUP_calls.fastq.gz | gzip > $wkdir/SUP_calls_no_hamster.fastq.gz
# conda deactivate
# 
# 
# 
...
# conda activate seqkit
# seqkit grep --threads 24 -f $wkdir/hamster_read_ids.txt $wkdir/SUP_calls.fastq.gz | gzip > $wkdir/SUP_calls_mapped_to_hamster.fastq.gz
# conda deactivate
# 
# 
# 
