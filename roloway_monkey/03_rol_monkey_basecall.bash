...
#SBATCH --job-name=rol_monkey_basecall
...
# #sed -i "s/[.]/\/share\/StickleAss\/OrgOne\/$species\/pod5_files/" ${config%.*}_tmp.txt # for the shared drive
# sed -i "s/[.]/\/gpfs01\/home\/mbzlld\/data\/OrgOne\/$species\/pod5_files/" ${config%.*}_tmp.txt # for files in my home drive
...
out_path=$(echo $pod5_path | cut -f9,10,11 -d '/') # so took the last 3 fields as the name instead (for files in my home directory)
